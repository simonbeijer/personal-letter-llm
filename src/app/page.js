    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="relative px-12 py-4 text-xl font-bold text-gray-800 bg-gradient-to-r from-slate-200 to-slate-300 hover:from-slate-300 hover:to-slate-400 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200 border-2 border-transparent"
              style={{
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-4 h-fit max-h-[280px]">
            <Card className="h-[80px]">
              <CardContent className="p-4 h-full flex items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">Smart Generation</h3>
            ...
            <Card className="h-[80px]">
              <CardContent className="p-4 h-full flex items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">Perfect Match</h3>
